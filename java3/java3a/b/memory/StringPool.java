...
public class StringPool {
	...
	public static void main(String[] args) {
		...
		String knihaString2 = "";
		//Date start = new Date() //tuto mozme urobit aktualnejsiu metodu LocalDateTime alebo starsich verzii Javy date: Date stop = new Date():
		...
		//tuto mozme urobit aktualnejsiu metodu LocalDateTime alebo starsich verzii Javy date: Date stop = new Date()
	...
	// pozri triedu StringBuffer - vobec nedava zapisy do StringPool pamate, rovno do Ramky. + tam je buffrovaci mechanizmus co este optimalizuje pracu s ramkovu kedze zapisuje po velkych kusoch
		System.out.println(Duration.between(start, stop).getSeconds() + ","+ Duration.between(start,stop).getNano());
	}
